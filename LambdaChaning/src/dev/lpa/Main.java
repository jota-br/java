...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Function<String, String[]> f1 = uCase
                .compose(lastName)
                .andThen(s -> s.split(" "));
        System.out.println(Arrays.toString(f1.apply(name)));
        ...
        Function<String, Integer> f3 = uCase
                .compose(lastName)
                .andThen(s -> s.split(" "))
        ...
        List<Predicate<String>> appliance = new ArrayList<>(List.of(
                p1,p2,p3,p4
        ));

        int i = 1;
        for (var func : appliance) {
            System.out.println("test" + i++ + " " + func.test(name));
        }
        ...
        Predicate<String> combined3 = p3.and(p4).negate(); //negate() is similar to if (!true)
